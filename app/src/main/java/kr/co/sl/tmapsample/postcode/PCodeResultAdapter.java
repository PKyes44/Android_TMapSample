package kr.co.sl.tmapsample.postcode;
...
public class PCodeResultAdapter extends BaseAdapter {
    ...
    public PCodeResultAdapter( Context context, ArrayList<PostCode.PostCodeVO> alPostCodeVO ) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if( convertView == null ) {
            ...
            convertView = inflater.inflate(R.layout.item_pcode_result, null);
        ...
        PostCode.PostCodeVO postCodeVO = alPostCodeVO.get(position);
